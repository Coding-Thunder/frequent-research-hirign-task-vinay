...
const Home: React.FC = () => {
        ...
        try {
            if (age > 14) {
                ...
                let created = await MyAxios.post("/user", {
                    firstName, lastName, email, country: country.name, state: state.name, city, gender, dateOfBirth, age:String(age)
                })
                if (created) {
    ...
    return (
        <div className='home'>
            ...
            {isFourteen ? (
                <>Sorry You're still Not Fourteen</>
            ) : (
                <>
                    <div className='home__form'>
                        <form onFocus={(event) => {
                            ...
                            <div className="form-group">
                                ...
                                <input value={age} onChange={e => setAge(Number(e.target.value))} type="number" className="form-control" id="age" placeholder="Enter age" />
                            </div>
